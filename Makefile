#############################################################################
# Makefile for building: digitalrs-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: Mon Aug 22 18:35:38 2016
# Project:  DigitalRS-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake RELEASE=1 -o Makefile DigitalRS-qt.pro
#############################################################################
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -Wl,-Bstatic -lminiupnpc /tmp/custom/digitalrs-source/src/leveldb/libleveldb.a /tmp/custom/digitalrs-source/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -Wl,-Bdynamic -lrt -ldl -lpthread -lQtGui -lQtCore 
AR            = ar cqs
RANLIB        = 
...
Makefile: DigitalRS-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) RELEASE=1 -o Makefile DigitalRS-qt.pro
...
/tmp/custom/digitalrs-source/src/leveldb/libleveldb.a: FORCE
	cd /tmp/custom/digitalrs-source/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/tmp/custom/digitalrs-source/build/build.h: FORCE
	cd /tmp/custom/digitalrs-source; /bin/sh share/genbuild.sh /tmp/custom/digitalrs-source/build/build.h
